...
# PGHOST defaults to the `db` service in docker-compose.yml; override for host-side runs.
config :grid_master, GridMaster.Repo,
  username: "postgres",
  password: "postgres",
  hostname: System.get_env("PGHOST", "db"),
  database: "grid_master_dev",
  stacktrace: true,
...
config :grid_master, GridMasterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "TjBKnjRbPNMJrCZuwI+3r0FqlvJzwwfiiAummUjn7vu4eMAm/DCkqI890qnKbmGb",
  watchers: []
